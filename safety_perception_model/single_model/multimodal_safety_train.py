...
def main(variables_dict=None):
    ...
    parameters = {
        ...
        'placepulse_datapath': "/data2/cehou/LLM_safety/img_text_data/finished/Stockholm_dataset_baseline_baseline_baseline_baseline_all_4910.csv", # HK path: "/data2/cehou/LLM_safety/img_text_data/baseline/tidyed/dataset_baseline_baseline_baseline_baseline_14294_withlabel.csv",
