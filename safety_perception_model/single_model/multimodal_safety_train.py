...
def main(variables_dict=None):
    ...
    parameters = {
        ...
        'placepulse_datapath': "/data2/cehou/LLM_safety/Stockholm/Stockholm_dataset_baseline_4910_withlabel.csv", # HK path: "/data2/cehou/LLM_safety/img_text_data/baseline/tidyed/dataset_baseline_baseline_baseline_baseline_14294_withlabel.csv",
