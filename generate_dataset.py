    ...
    for idx in tqdm(random_indices[i:]):
        ...
        if args.gender == "baseline":
            ...
            question_list = [
                    ...
                    ["Based on your answers, evaluate the safety perception brought to you by the street scenes in the panoramic street view image one by one. Please answer this question within 300 words.", None],
